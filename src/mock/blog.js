...
Mock.mock('/api/blogCategories', 'get', {
  code: 0,
  msg: '',
  'data|10-20': [
    {
...
Mock.mock(/^\/api\/blog\/[^/]+$/, 'get', {
  ...
  <p>所以，CORS是一种更好的跨域解决方案。</p><h1 id="article-md-title-1">概述</h1><p><code>CORS</code>是基于<code>http1.1</code>的一种跨域解决方案，它的全称是<strong>C</strong>ross-<strong>O</strong>rigin <strong>R</strong>esource <strong>S</strong>haring，跨域资源共享。</p><p>它的总体思路是：<strong>如果浏览器要跨域访问服务器的资源，需要获得服务器的允许</strong></p><figure class="markdown-image">
        ...
        <img style="width:auto" src="https://github.com/user-attachments/assets/efb15ada-29ac-443d-802f-999c21d85dfb" title="image-20200421152122793" alt="image-20200421152122793">
  ...
  消息体中的数据</code></pre><p>当浏览器看到服务器允许自己访问后，高兴的像一个两百斤的孩子，于是，它就把响应顺利的交给js，以完成后续的操作</p><p>下图简述了整个交互过程</p><figure class="markdown-image">
        ...
        <img style="width:auto" src="https://github.com/user-attachments/assets/639d4181-1fd9-4ad0-8a63-c1c872f7e2ad" title="image-20200421162846480" alt="image-20200421162846480">
  ...
  添加用户成功</code></pre><p>可以看出，当完成预检之后，后续的处理与简单请求相同</p><p>下图简述了整个交互过程</p><figure class="markdown-image">
        ...
        <img style="width:auto" src="https://github.com/user-attachments/assets/36a1a86d-be34-49b0-bdd5-0413321b6d27" title="image-20200421165913320" alt="image-20200421165913320">
